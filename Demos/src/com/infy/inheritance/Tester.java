...
public class Tester {
	public static void main(String[] args) {
		Pizza[] pizzaList1 = { new Pizza("Regular", 1), new Pizza("Large", 2) };
		...
		System.out.println(
				"Total cost for SuperFoodie " + superFoodie.getFoodieName() + ": " + superFoodie.getTotalPrice());
		...
		System.out.println("Total cost for UltraFoodie " + ultraFoodie.getFoodieName() + ": "
				+ ultraFoodie.getTotalPrice() + " with Reward Points: " + ultraFoodie.getRewardPoints());
	}
}
